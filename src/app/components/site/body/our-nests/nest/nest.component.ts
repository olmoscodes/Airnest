...
export class NestComponent implements OnInit {
  ...
  Links = [
    ...
    new Link('https://urbansuites.airnest.es/listings', 'Triana-Suites'),
    new Link('https://sanmarcial.airnest.es/listings', 'Casa-San-Marcial'),
    ...
    new Link('https://lascasas.airnest.es/listings', 'Las-Casas-de-Maspalomas'),
