...
export class NestComponent implements OnInit {
  ...
  Links = [
    new Link('https://airnest.guestybookings.com/listings/6063963b5301ad002f8a49e8', 'Lomo-Quiebre'),
    new Link('https://airnest.guestybookings.com/listings/603ab94ab1c122002e83eaf7', 'Taoyo-Suites-I'),
    new Link('https://airnest.guestybookings.com/listings/5eea21689e4410002dfa5b8b', 'Las-Canteras-I'),
    new Link('https://airnest.guestybookings.com/listings/5f1310396b86b4002ca39323', 'Las-Canteras-II'),
    new Link('https://airnest.guestybookings.com/listings/5eea214baaf3a10029b8eb6c', 'Lagos-Villa-I'),
    new Link('https://airnest.guestybookings.com/listings/5eea213a9e4410002dfa54be', 'Las-Palmas-City-Center'),
    new Link('https://airnest.guestybookings.com/listings/5fd50333387fe30032d18df1', 'Patalavaca-Apartment-I'),
    new Link('https://airnest.guestybookings.com/listings/5fe0df09377861002ea7d2a0', 'Patalavaca-Apartment-II'),
    new Link('https://airnest.guestybookings.com/listings/5fd8f25e24b300002db30c23', 'Patalavaca-Apartment-III'),
    ...
    new Link('https://airnest.guestybookings.com/listings/5eea2194aaf3a10029b8f1c9', 'Lagos-Villa-III'),
    new Link('https://airnest.guestybookings.com/listings/5eea21439e4410002dfa5734', 'Lagos-Villa-IV'),
    new Link('https://airnest.guestybookings.com/listings/603ab93e71ed9c002f064cd5', 'Taoyo-Suites-IV'),
