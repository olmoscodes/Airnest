...
export class OurNestsComponent implements OnInit {
  ...
  Nests = [
    ...
    new Nest(5,'Lagos-Villa-I', 'Lagos-Villa I | Gran Canaria', 'Beautiful modern Villa in 5 stars Golf Resort', 5, 2, 'https://ournests.airnest.es/listings/5eea214baaf3a10029b8eb6c'),
    ...
    new Nest(30,'Las-Lomas', 'Las Lomas | Gran Canaria', 'Beachside apartment in Las Lomas', 5, 2,'https://ournests.airnest.es/listings/60d990b6aa31a30030d12716'),
    ...
    new Nest(38,'Seaside-Villa', 'Seaside Villa | La Graciosa', 'Beautiful rural house in a remote little village', 8, 4,'https://ournests.airnest.es/listings/5eea21adaaf3a10029b8f605'),
    ...
    new Nest(44,'Lagos-Villa-III', 'Lagos Villa III | Gran Canaria', 'Beautiful modern Villa in 5 stars Golf Resort', 5, 2,'https://ournests.airnest.es/listings/5eea2194aaf3a10029b8f1c9'),
